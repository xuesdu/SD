function S = assemble_stabilizer_Stokes(Omega,fun,dof_trial,dof_test,P,T,neighbors,number_of_elements,Tb_test,Tb_trial,Gauss_weights_ref_1D,Gauss_nodes_ref_1D,...
