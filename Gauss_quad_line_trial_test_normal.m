function int_value = Gauss_quad_line_trial_test_normal(fun1,fun2,end_point_1,end_point_2,normal,Gauss_weights_ref_1D,Gauss_nodes_ref_1D)
...
if end_point_1(2) == end_point_2(2)  % 水平边界
    ...
    for i = 1:Gpn
        ...
        int_value = int_value + Gauss_weights_1D(i)*(fun1(x,y)*normal(1)+fun2(x,y)*normal(2));
    end
