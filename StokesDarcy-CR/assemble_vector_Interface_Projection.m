function A = assemble_vector_Interface_Projection(Omega,fun,dof_test,P,T,Inter,Tb_test,Gauss_weights_ref_1D,Gauss_nodes_ref_1D,number_of_local_basis_test,...
