function A = assemble_vector_Interface(Omega,fun,dof_test,Tb_test,Gauss_weights_ref_1D,Gauss_nodes_ref_1D,number_of_local_basis_test,...
        ...
        end_point_2 = vertices(:,1);
            for beta = 1:number_of_local_basis_test
                int_value = Gauss_quad_line_trial_test(fun,end_point_1,end_point_2,Gauss_weights_ref_1D,Gauss_nodes_ref_1D,vertices,...
                    200,0,0,0,0,basis_type_test,beta,basis_vector_test,basis_der_x_test,basis_der_y_test);
