function A = assemble_matrix_interface(Omega,fun,dof_trial,dof_test,Tb_test,Tb_trial,Gauss_weights_ref_1D,Gauss_nodes_ref_1D,number_of_local_basis_trial,number_of_local_basis_test,...
...
elseif Omega == 'fp'
    for n = 1:size(Inter.Tp,2)    % 遍历单元
        ...
        for alpha = 1:number_of_local_basis_trial
            for beta = 1:number_of_local_basis_test
                int_value = Gauss_quad_line_trial_test_Omegaf_Omegap(fun,end_point_1,end_point_2,Gauss_weights_ref_1D,Gauss_nodes_ref_1D,vertices_f,vertices_p,...
                    basis_type_trial,alpha,basis_vector_trial,basis_der_x_trial,basis_der_y_trial,...
                    basis_type_test,beta,basis_vector_test,basis_der_x_test,basis_der_y_test);
