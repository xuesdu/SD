...
for ch = 0:4
    ...
    Asd = sparse(length(As),length(Ad));  % Asd(1:dof_us,1:dof_ud) = -S_I1;
    A = [ As     Asd;
          Asd'   Ad];
...
%     end
    ...
    if pp == 1
        ...
        fprintf('%7.0f %s %7.2e %s %7.2f %s %7.2e %s %7.2f %s %7.2e %s %7.2f %s %7.2e %s %7.2f %s %d\n',Nx,...
            '&',error_H1_us,'&',error_H1_us_order,'&',error_L2_ps,'&',error_L2_ps_order,...
