...
if end_point_1(2) == end_point_2(2)  % 水平边界
    ...
    for i = 1:Gpn
        ...
        int_value = int_value + Gauss_weights_1D(i)*fun(x,y)*...
            FE_basis_fun_local(x,y,vertices,edge_index,basis_type_trial,basis_index_trial,basis_vector_trial,basis_der_x_trial,basis_der_y_trial)*...
            FE_basis_fun_local(x,y,vertices,edge_index,basis_type_test,basis_index_test,basis_vector_test,basis_der_x_test,basis_der_y_test);
    end
