function Proj = assemble_projection_matrix_interface(dof_Stokes,dof_Darcy_new,E,Inter,Ny)

Proj = sparse(dof_Stokes+dof_Darcy_new,dof_Stokes+dof_Darcy_new-Ny);
for i = 1:dof_Stokes
    Proj(i,i) = 1;
end
for i = dof_Stokes+Ny+1:dof_Stokes+dof_Darcy_new
    Proj(i,i-Ny) = 1;
end
