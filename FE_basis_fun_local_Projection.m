...
for i = 1:3
    mid_point_value(i) = FE_basis_fun_local(mid_point(1,i),mid_point(2,i),vertices,basis_type,basis_index,basis_vector,basis_der_x,basis_der_y);
end
normal = generate_normal_vector(vertices);
A = zeros(3);
for i = 1:3
    A(i,1) = normal(1,i);
    A(i,2) = normal(2,i);
