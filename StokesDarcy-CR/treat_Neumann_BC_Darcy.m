function bg = treat_Neumann_BC_Darcy(para, P, T, be, dof_u, Tb_test, number_of_elements, Nx, Ny, hx)
...
for n = 1:nbe
    if be(6,n) == -2        
        ...
        vertices = P(:,T(:,elements_index+number_of_elements));
        for alpha = 1:3  % 局部基函数的个数
            mx1 = FE_basis_fun_local(x,y,vertices,201,alpha,0,0);
            mx2 = FE_basis_fun_local(x,y,vertices,201,alpha,0,0);
