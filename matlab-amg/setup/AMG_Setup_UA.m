function [ amgData ] = AMG_Setup_UA( Af, amgParam )
% Setup phase for unsmoothed aggregation AMG (UAAMG) method
%
...
if print_level > 0
    ...
    fprintf('----------------------------------------------------\n');
    fprintf('      UA AMG setup costs %f seconds\n', setup_duration);
    fprintf('----------------------------------------------------\n');
